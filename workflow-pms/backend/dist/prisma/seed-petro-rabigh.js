...
exports.ensurePetroRabighPortfolio = ensurePetroRabighPortfolio;
const client_1 = require("@prisma/client");
async function ensurePetroRabighPortfolio(prisma, adminUserId) {
    ...
    const projects = [
        {
            ...
            line: {
                ...
                currentStage: client_1.WorkflowStage.DESIGNING_ENGINEERING,
                technicalDetails: {
                    slNo: 1,
                    location: 'YANBU',
                    wbs: '',
    ...
    for (const p of projects) {
        ...
        const line = await prisma.lineItem.create({
            data: {
                ...
                technicalDetails: p.line.technicalDetails,
            },
        });
        if (p.seedEngineering) {
            ...
            await prisma.manHourEntry.create({
                data: {
                    lineItemId: line.id,
                    stage: client_1.WorkflowStage.DESIGNING_ENGINEERING,
                    year: baseYear,
                    month: baseMonth,
        ...
        if (p.seedInvoice) {
            await prisma.manHourEntry.createMany({
                data: [
                    ...
                    {
                        lineItemId: line.id,
                        stage: client_1.WorkflowStage.INVOICE,
                        year: baseYear,
                        month: 3,
    ...
    console.log(`Petro Rabigh Yanbu: created ${projects.length} projects (PRJ-YANBU-2026-001 … 004).`);
}
//# sourceMappingURL=seed-petro-rabigh.js.map